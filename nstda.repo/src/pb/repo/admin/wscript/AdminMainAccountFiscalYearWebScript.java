...
public class AdminMainAccountFiscalYearWebScript {
	
	private static Logger log = Logger.getLogger(AdminMainAccountFiscalYearWebScript.class);
	
	private static final String URI_PREFIX = CommonConstant.GLOBAL_URI_PREFIX + "/admin/main/fiscalyear";
	
	@Autowired
	private AdminAccountFiscalYearService fiscalYearService;
  ...
  public void handleList(final WebScriptResponse response)  throws Exception {
		...
		try {
			List<Map<String, Object>> list = fiscalYearService.list();
