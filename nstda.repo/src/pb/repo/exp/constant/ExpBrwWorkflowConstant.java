...
public class ExpBrwWorkflowConstant extends MainWorkflowConstant {
    
    /*
     * Workflow Model Properties
     */
    public static final String MODEL_URI = "http://www.nstda.or.th/model/workflow/expbrwwf/1.0";
    public static final String WF_URI = "{"+MODEL_URI+"}";
    public static final String MODEL_PREFIX = "expbrwwf_";
...
//    public static final QName PROP_COMMENT_HISTORY = QName.createQName(MODEL_URI, "commentHistory");
    ...
    public static final QName PROP_ACCEPTER = QName.createQName(MODEL_URI, "accepter");
    public static final QName PROP_ACCEPT = QName.createQName(MODEL_URI, "accept");
