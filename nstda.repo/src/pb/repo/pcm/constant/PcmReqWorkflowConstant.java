...
public class PcmReqWorkflowConstant extends MainWorkflowConstant {
    
    /*
     * Workflow Model Properties
     */
    public static final String MODEL_URI = "http://www.nstda.or.th/model/workflow/pcmreqwf/1.0";
    public static final String WF_URI = "{"+MODEL_URI+"}";
    public static final String MODEL_PREFIX = "pcmreqwf_";
...
//    public static final QName PROP_COMMENT_HISTORY = QName.createQName(MODEL_URI, "commentHistory");
    ...
    public static final QName PROP_REF_DOCUMENT = QName.createQName(MODEL_URI, "refDocument");
