Ext.define('PBExp.view.MainFormVoyagerTab', {
    extend: 'Ext.panel.Panel',
    alias:'widget.expBrwVoyagerTab',
	...
	initComponent: function(config) {
		...
		var estore = Ext.create('PBExp.store.VoyagerGridStore');
		...
		var ostore = Ext.create('PBExp.store.VoyagerGridStore');
