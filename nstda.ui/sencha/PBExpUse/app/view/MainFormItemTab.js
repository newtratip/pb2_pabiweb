Ext.define('PBExpUse.view.MainFormItemTab', {
	...
	initComponent: function(config) {
		...
		columns.push(
				...
				{ text: 'รายการเบิกจ่าย',  dataIndex: 'activityName', flex:1},
				{ text: 'เงื่อนไขการเบิกจ่าย',  dataIndex: 'condition1', flex:1, renderer:function(v){return (v ? v :"")}},
				{ text: 'จำนวนเงินที่ขอเบิก',  dataIndex: 'amount', width:180, align:'right', xtype: 'numbercolumn', format:'0,000.00'}
		);
