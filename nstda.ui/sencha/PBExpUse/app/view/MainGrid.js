Ext.define('PBExpUse.view.MainGrid', {
    extend: 'Ext.grid.Panel',
    alias:'widget.expUseMainGrid',
...
//	                }
		...
		Ext.Ajax.request({
		      url:ALF_CONTEXT+"/exp/use/gridfield/list",
		      method: "GET",
	...
	indicator:{
		...
		"C3":{color:"green", text_th:"การเงินจ่ายเงิน", text_en:"Accepted"},
		"X1":{color:"darkgray", text_th:"ผู้ขอยกเลิก", text_en:"Cancelled By Requester"},
		"X2":{color:"darkgray", text_th:"การเงินยกเลิก", text_en:"Cancelled By Accounting"},
