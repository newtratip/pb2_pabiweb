...
<@markup id="css" >
   <#-- CSS Dependencies -->
	<@link rel="stylesheet" type="text/css" href="${url.context}/res/page/PBPcmOrd/resources/PBPcmOrd-all.css" />
...
<@markup id="js">
   <#-- JavaScript Dependencies -->
	...
	<@script type="text/javascript" src="${url.context}/res/page/PBPcmOrd/app.js"></@script>
</@>

<@markup id="widgets">
   <@createWidgets group="pcmOrd"/>
</@>
