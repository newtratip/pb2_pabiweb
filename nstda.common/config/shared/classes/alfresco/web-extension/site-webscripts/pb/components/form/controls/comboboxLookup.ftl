...
<@markup id="js">
   <#-- JavaScript Dependencies -->
	...
	<@script type="text/javascript" src="${url.context}/res/js/common/comboboxLookup.js"></@script>
</@>
...
<script type="text/javascript">
	...
	YAHOO.util.Event.onDOMReady(function(){
		...
		renderComboboxLookup("${field.control.params.fieldName}","${fieldValue?html}","${field.name}","${field.control.params.readOnly}","${field.control.params.url}","${field.control.params.type}","${field.control.params.width}");	
