...
<@script type="text/javascript" src="${url.context}/res/components/upload/file-upload.js" group="form"></@script>
<@script type="text/javascript" src="${url.context}/res/components/upload/html-upload.js" group="form"></@script>
<@script type="text/javascript" src="${url.context}/res/components/upload/qs-flash-upload.js" group="form"></@script>
<@script type="text/javascript" src="${url.context}/res/components/upload/dnd-upload.js" group="form"></@script>
<@script type="text/javascript" src="${url.context}/res/components/object-finder/qs-object-finder.js" group="form"></@script>
<@script type="text/javascript" src="${url.context}/res/components/form/commentDataTable.js" group="form"/>
...
<#--Customs JavaScript Dependencies 
<@script type="text/javascript" src="${url.context}/res/page/common/constant.js" group="form"/>
<@script type="text/javascript" src="${url.context}/res/page/common.js" group="form"/>
<@script type="text/javascript" src="${url.context}/res/page/common/util.js" group="form"/>
-->