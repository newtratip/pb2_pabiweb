...
//	  success: function(o){
          ...
          var variablesColumnDefs =
        	  [
               ...
               {
                  key:"user", label: this.msg("form.control.details.column.userColumnHeader"), sortable:true,resizeable:true,
                  formatter:function(elCell, oRecord, oColumn, oData)
                  {
               ...
               {
                   key:"action", label: this.msg("form.control.details.column.actionColumnHeader"), sortable:true,resizeable:true,
                   formatter:function(elCell, oRecord, oColumn, oData)
                   {
                      elCell.innerHTML = oData;
                   }
            ...
            var grdData = YAHOO.lang.JSON.parse(fieldValue);
